...
** VENDOR_EDIT
** File: - oplus_smart_bw_decision.h
...
#ifndef _OPLUS_SMART_BW_DECISION_H
#define _OPLUS_SMART_BW_DECISION_H
...
/* kernel offical timeout is 30s, OPLUS FWK period scan is 15s, set to multiple */
...
#endif
#endif
/* data come from FWK rom update => kernel oplus sla => WIFI driver, they must have the same data member order */
...
#endif /* _OPLUS_SMART_BW_DECISION_H */
