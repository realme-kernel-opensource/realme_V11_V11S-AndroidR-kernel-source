...
struct upgrade_fw_info nvt_fw_list[] = {
    ...
    {HLT_BOE_B3, "HLT_B3", BOOT_UPDATE_FIRMWARE_HLT_BOE_B3_NAME,  MP_UPDATE_FIRMWARE_HLT_BOE_B3_NAME, up_fw_kernel_hlt_boe_b3, sizeof(up_fw_kernel_hlt_boe_b3), OPPO_BOOT_UPDATE_FIRMWARE_HLT_BOE_B3_NAME},
};
