...
#elif defined CONFIG_OPLUS_SM7125_CHARGER
#include "charger_ic/oplus_battery_msm7125_Q.h"
...
#define	NOTIFY_FLASHLIGHT_OVER_TEMP			22
...
#ifdef CONFIG_OPLUS_CHARGER_MTK6769
/*Liu.Yong@RM.CM.BSP.CHG 2020/08/22, Add for 6769 charger code*/
	...
	int	batt_temp_extend_t5_to_t6_ichg;
	int	batt_temp_extend_t6_to_t7_ichg;
...
/*	struct battery_data battery_main	*/
	...
	bool pd_chging;
	bool qc_chging;
	OPLUS_CHG_AP_TEMP_STAT ap_sm;
	OPLUS_CHG_BATT_TEMP_EXTEND_STAT jeita_sm;
	struct device_node *fast_node;
	struct alarm usbotp_recover_timer; 
...
#ifdef CONFIG_OPLUS_CHARGER_MTK6769
/*Liu.Yong@RM.CM.BSP.CHG 2020/08/22, Add charger code*/
	int (*oplus_chg_get_pe20_type)(void);
	int (*oplus_chg_pe20_setup)(void);
	int (*oplus_chg_reset_pe20)(void);
