...
#elif defined(CONFIG_OPLUS_CHARGER_MTK6763) || defined(CONFIG_OPLUS_CHARGER_MTK6889)|| defined(CONFIG_OPLUS_CHARGER_MTK6853)
#include <linux/module.h>
...
{
#ifdef CONFIG_OPLUS_CHARGER_MTK
#if defined(CONFIG_OPLUS_CHARGER_MTK6763) || defined(CONFIG_OPLUS_CHARGER_MTK6771) || defined(CONFIG_OPLUS_CHARGER_MTK6873)|| defined(CONFIG_OPLUS_CHARGER_MTK6853)
	int ret = 0;
...
int bq25601d_input_current_limit_write(int value)
{
	...
	reg_value = (value - 100)/100;
	rc = bq25601d_config_interface(chip, REG00_BQ25601D_ADDRESS, reg_value, REG00_BQ25601D_INPUT_CURRENT_LIMIT_MASK);
	if (rc < 0) {
...
#if defined (CONFIG_MTK_PMIC_CHIP_MT6353) || defined(CONFIG_OPLUS_CHARGER_MTK6763) || defined(CONFIG_OPLUS_CHARGER_MTK6771)|| defined(CONFIG_OPLUS_CHARGER_MTK6853) || defined(CONFIG_OPLUS_CHARGER_MTK6873)
...
static int bq25601d_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
...
#endif  /* CONFIG_OPLUS_CHARGER_MTK */
	chg_debug("bq25601d_driver_probe call \n");
	...
	chg_debug("bq25601d_driver_probe call OK!\n");
	return 0;
}
