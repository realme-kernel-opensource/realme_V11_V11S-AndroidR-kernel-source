...
#define REG01_MP2650_VINDPM_THRESHOLD_DEFALT                  (BIT(5) |BIT(3) | BIT(2) | BIT(0))    //default 4.5V
...
#define REG02_MP2650_CHARGE_CURRENT_SETTING_DEFALT           (BIT(4) | BIT(2))    //default 1A


/* Address:03h */
#define REG03_MP2650_ADDRESS                                   0x03

#define REG03_MP2650_TERMINATION_CURRENT_LIMIT_MASK            (BIT(5) | BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define REG03_MP2650_TERMINATION_PRECHARGE_CURRENT_LIMIT_DEFALT		(BIT(5) | BIT(4) | BIT(1))  //PRECHARGE 180ma   termination 200ma
...
#define REG04_MP2650_CHARGE_FULL_VOL_DEFALT			(BIT(6) | BIT(3) | BIT(2) | BIT(1))//chargefull defalt 4.2v
...
#define REG05_MP2650_THERMAL_REGULATION_THRESHOLD_DEFALT		(BIT(1) | BIT(0))	//default 120
...
struct oplus_chg_operations *  svooc_oplus_get_chg_ops(void);
#else
...
#ifdef CONFIG_OPLUS_CHARGER_MTK6785
extern int oplus_mt6360_pd_setup(void);
extern bool oplus_mt6360_get_pd_type(void);
extern bool oplus_mt6360_get_vbus_status(void);
extern int oplus_chg_enable_hvdcp_detect(void);
