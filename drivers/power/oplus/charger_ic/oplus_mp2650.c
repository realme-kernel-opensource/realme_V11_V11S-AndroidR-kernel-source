...
int mp2650_reset_charger(void)
{
    ...
    //rc = mp2650_config_interface(REG08_MP2650_ADDRESS, 
		//REG08_MP2650_REG_RST_RESET, REG08_MP2650_REG_RST_MASK);
	rc = mp2650_config_interface(REG00_MP2650_ADDRESS, 0, REG01_MP2650_VINDPM_THRESHOLD_MASK);
	rc = mp2650_config_interface(REG01_MP2650_ADDRESS, REG01_MP2650_VINDPM_THRESHOLD_DEFALT, REG01_MP2650_VINDPM_THRESHOLD_MASK);
	rc = mp2650_config_interface(REG02_MP2650_ADDRESS, REG02_MP2650_CHARGE_CURRENT_SETTING_DEFALT, REG02_MP2650_CHARGE_CURRENT_SETTING_MASK);
	rc = mp2650_config_interface(REG03_MP2650_ADDRESS, REG03_MP2650_TERMINATION_PRECHARGE_CURRENT_LIMIT_DEFALT, REG03_MP2650_TERMINATION_CURRENT_LIMIT_MASK);
	rc = mp2650_config_interface(REG04_MP2650_ADDRESS, REG04_MP2650_CHARGE_FULL_VOL_DEFALT, REG04_MP2650_CHARGE_FULL_VOL_MASK);
	rc = mp2650_config_interface(REG05_MP2650_ADDRESS, REG05_MP2650_THERMAL_REGULATION_THRESHOLD_DEFALT, REG05_MP2650_THERMAL_REGULATION_THRESHOLD_MASK);
	...
	rc = mp2650_config_interface(REG07_MP2650_ADDRESS, REG07_MP2650_OTG_CURRENT_LIMIT_1A, REG07_MP2650_OTG_CURRENT_LIMIT_MASK);
	rc = mp2650_config_interface(REG07_MP2650_ADDRESS, REG07_MP2650_PRECHARGE_THRESHOLD_6000MV, REG07_MP2650_PRECHARGE_THRESHOLD_MASK);
	rc = mp2650_config_interface(REG08_MP2650_ADDRESS, REG08_MP2650_BFET_ENABLE, REG08_MP2650_BFET_EN_MASK);
	rc = mp2650_config_interface(REG08_MP2650_ADDRESS, REG08_MP2650_NTC_GCOMP_SEL_ORIGINAL, REG08_MP2650_NTC_GCOMP_SEL_MASK);
	rc = mp2650_config_interface(REG08_MP2650_ADDRESS, REG08_MP2650_CHG_EN_ENABLE, REG08_MP2650_CHG_EN_MASK);
	rc = mp2650_config_interface(REG09_MP2650_ADDRESS, REG09_MP2650_FAST_CHARGE_TIMER_12H, REG09_MP2650_FAST_CHARGE_TIMER_MASK);
	rc = mp2650_config_interface(REG09_MP2650_ADDRESS, REG09_MP2650_CHARGE_TIMER_EN_ENABLE, REG09_MP2650_CHARGE_TIMER_EN_MASK);
	...
	rc = mp2650_config_interface(REG0A_MP2650_ADDRESS, REG0A_MP2650_NTC_COOL_686_PERMILLE, REG0A_MP2650_NTC_COOL_MASK);
	rc = mp2650_config_interface(REG0A_MP2650_ADDRESS, REG0A_MP2650_NTC_WARM_561_PERMILLE, REG0A_MP2650_NTC_WARM_MASK);
	rc = mp2650_config_interface(REG0A_MP2650_ADDRESS, REG0A_MP2650_NTC_CTRL_DISABLE, REG0A_MP2650_NTC_CTRL_MASK);
	rc = mp2650_config_interface(REG0B_MP2650_ADDRESS, 0, 0xFF);
	rc = mp2650_config_interface(REG0C_MP2650_ADDRESS, 0x12, 0xFF);
	rc = mp2650_config_interface(REG0D_MP2650_ADDRESS, 0x13, 0xFF);
	rc = mp2650_config_interface(REG0E_MP2650_ADDRESS, 0x14, 0xFF);
	...
	mp2650_dump_registers();
	chg_err("mp2650_reset_charger rc = %d\n", rc);
...
bool __attribute__((weak)) oplus_usb_or_otg_is_present(void)
{
	return false;
}
