		...
		const struct i2c_device_id *id)
{
	...
	switch (chip->vooc_fw_type) {
		...
		case VOOC_FW_TYPE_STM8S_4450_FFC_SHORT_RESET_WINDOW:
			chip->firmware_data = Stm8s_fw_data_4450_ffc_short_reset_window;
			chip->fw_data_count = sizeof(Stm8s_fw_data_4450_ffc_short_reset_window);
			chip->fw_data_version = Stm8s_fw_data_4450_ffc_short_reset_window[chip->fw_data_count - 4];
			break;
