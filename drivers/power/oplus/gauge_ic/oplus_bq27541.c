...
static bool bq27541_sha1_hmac_authenticate(void)
{
	...
	#endif
	if(gauge_ic && gauge_ic->sha1_key_index == 1)
		goto sha1_key_1;
	Key[15] = 0x01;
	Key[14] = 0x23;
	Key[13] = 0x45;
