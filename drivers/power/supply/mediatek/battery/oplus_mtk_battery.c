...
extern bool is_project_pascalAC(void);
#endif
...
/************ kpoc_charger *******************/
    case Get_FakeOff_Param:
		...
		if (oplus_get_prop_status() == POWER_SUPPLY_STATUS_CHARGING) {
...
/*
signed int oplus_battery_get_bat_soc(void)
{
