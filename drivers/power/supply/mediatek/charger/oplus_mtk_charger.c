...
#if defined(VENDOR_EDIT) && defined(CONFIG_OPLUS_CHARGER_MT6370_TYPEC)
...
static int oplus_mt6370_charging_current_write_fast(int chg_curr);
...
static int oplus_mt6370_hardware_init(void)
{
	...
	oplus_mt6370_set_rechg_voltage(100);
...
struct oplus_chg_operations mt6370_chg_ops;
static int oplus_mt6370_input_current_limit_write(int value)
{
	...
	if (mt6370_chg_ops.oplus_chg_get_pd_type) {
		if (mt6370_chg_ops.oplus_chg_get_pd_type() == true) {
...
/*static bool oplus_mt6370_get_vbus_status(void)
{
...
//====================================================================//
#if defined(VENDOR_EDIT) && defined(CONFIG_OPLUS_CHARGER_MT6370_TYPEC)
static bool oplus_mt6370_get_pd_type(void)
{
	if (pinfo != NULL) {
