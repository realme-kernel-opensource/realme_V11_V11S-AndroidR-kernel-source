...
_CODE HDMITXDEV
	InstanceData = {
		...
		/* /////////////////////////////////////////////// */
		INPUT_SIGNAL_TYPE,
		/* unsigned char bInputVideoSignalType ;
		 * for Sync Embedded,CCIR656,InputDDR
		 */
...
static HDMI_VTiming _CODE s_VMTable[] = {
	...
	{1, 0, 640, 480, 800, 525, 25175000L, 0x89, 16, 96, 48, 10, 2, 33, PROG,
	 Vneg, Hneg},
	/* 640x480@60Hz */
	{2, 0, 720, 480, 858, 525, 27000000L, 0x80, 16, 62, 60, 9, 6, 30, PROG,
	 Vneg, Hneg},
	/* 720x480@60Hz */
	{3, 0, 720, 480, 858, 525, 27000000L, 0x80, 16, 62, 60, 9, 6, 30, PROG,
	 Vneg, Hneg},
	/* 720x480@60Hz */
	{4, 0, 1280, 720, 1650, 750, 74250000L, 0x2E, 110, 40, 220, 5, 5, 20,
	 PROG, Vpos, Hpos},
	/* 1280x720@60Hz */
	{5, 0, 1920, 540, 2200, 562, 74250000L, 0x2E, 88, 44, 148, 2, 5, 15,
	 INTERLACE, Vpos, Hpos},
	/* 1920x1080(I)@60Hz */
	{6, 1, 720, 240, 858, 262, 13500000L, 0x100, 19, 62, 57, 4, 3, 15,
	 INTERLACE, Vneg, Hneg},
	/* 720x480(I)@60Hz */
	{7, 1, 720, 240, 858, 262, 13500000L, 0x100, 19, 62, 57, 4, 3, 15,
	 INTERLACE, Vneg, Hneg},
	/* 720x480(I)@60Hz */
	{8, 1, 720, 240, 858, 262, 13500000L, 0x100, 19, 62, 57, 4, 3, 15, PROG,
	 Vneg, Hneg},
	/* 720x480(I)@60Hz */
	{9, 1, 720, 240, 858, 262, 13500000L, 0x100, 19, 62, 57, 4, 3, 15, PROG,
	 Vneg, Hneg},
	/* 720x480(I)@60Hz */
	{10, 2, 720, 240, 858, 262, 54000000L, 0x40, 19, 62, 57, 4, 3, 15,
	 INTERLACE, Vneg, Hneg},
	/* 720x480(I)@60Hz */
	{11, 2, 720, 240, 858, 262, 54000000L, 0x40, 19, 62, 57, 4, 3, 15,
	 INTERLACE, Vneg, Hneg},
	/* 720x480(I)@60Hz */
	{12, 2, 720, 240, 858, 262, 54000000L, 0x40, 19, 62, 57, 4, 3, 15, PROG,
	 Vneg, Hneg},
	/* 720x480(I)@60Hz */
	{13, 2, 720, 240, 858, 262, 54000000L, 0x40, 19, 62, 57, 4, 3, 15, PROG,
	 Vneg, Hneg},
	/* 720x480(I)@60Hz */
	{14, 1, 1440, 480, 1716, 525, 54000000L, 0x40, 32, 124, 120, 9, 6, 30,
	 PROG, Vneg, Hneg},
	/* 1440x480@60Hz */
	{15, 1, 1440, 480, 1716, 525, 54000000L, 0x40, 32, 124, 120, 9, 6, 30,
	 PROG, Vneg, Hneg},
	/* 1440x480@60Hz */
	{16, 0, 1920, 1080, 2200, 1125, 148500000L, 0x17, 88, 44, 148, 4, 5, 36,
	 PROG, Vpos, Hpos},
	/* 1920x1080@60Hz */
	{17, 0, 720, 576, 864, 625, 27000000L, 0x80, 12, 64, 68, 5, 5, 39, PROG,
	 Vneg, Hneg},
	/* 720x576@50Hz */
	{18, 0, 720, 576, 864, 625, 27000000L, 0x80, 12, 64, 68, 5, 5, 39, PROG,
	 Vneg, Hneg},
	/* 720x576@50Hz */
	{19, 0, 1280, 720, 1980, 750, 74250000L, 0x2E, 440, 40, 220, 5, 5, 20,
	 PROG, Vpos, Hpos},
	/* 1280x720@50Hz */
	{20, 0, 1920, 540, 2640, 562, 74250000L, 0x2E, 528, 44, 148, 2, 5, 15,
	 INTERLACE, Vpos, Hpos},
	/* 1920x1080(I)@50Hz */
	{21, 1, 720, 288, 864, 312, 13500000L, 0x100, 12, 63, 69, 2, 3, 19,
	 INTERLACE, Vneg, Hneg},
	/* 1440x576(I)@50Hz */
	{22, 1, 720, 288, 864, 312, 13500000L, 0x100, 12, 63, 69, 2, 3, 19,
	 INTERLACE, Vneg, Hneg},
	/* 1440x576(I)@50Hz */
	{23, 1, 720, 288, 864, 312, 13500000L, 0x100, 12, 63, 69, 2, 3, 19,
	 PROG, Vneg, Hneg},
	/* 1440x288@50Hz */
	{24, 1, 720, 288, 864, 312, 13500000L, 0x100, 12, 63, 69, 2, 3, 19,
	 PROG, Vneg, Hneg},
	/* 1440x288@50Hz */
	{25, 2, 720, 288, 864, 312, 13500000L, 0x100, 12, 63, 69, 2, 3, 19,
	 INTERLACE, Vneg, Hneg},
	/* 1440x576(I)@50Hz */
	{26, 2, 720, 288, 864, 312, 13500000L, 0x100, 12, 63, 69, 2, 3, 19,
	 INTERLACE, Vneg, Hneg},
	/* 1440x576(I)@50Hz */
	{27, 2, 720, 288, 864, 312, 13500000L, 0x100, 12, 63, 69, 2, 3, 19,
	 PROG, Vneg, Hneg},
	/* 1440x288@50Hz */
	{28, 2, 720, 288, 864, 312, 13500000L, 0x100, 12, 63, 69, 2, 3, 19,
	 PROG, Vneg, Hneg},
	/* 1440x288@50Hz */
	{29, 1, 1440, 576, 1728, 625, 54000000L, 0x40, 24, 128, 136, 5, 5, 39,
	 PROG, Vpos, Hneg},
	/* 1440x576@50Hz */
	{30, 1, 1440, 576, 1728, 625, 54000000L, 0x40, 24, 128, 136, 5, 5, 39,
	 PROG, Vpos, Hneg},
	/* 1440x576@50Hz */
	{31, 0, 1920, 1080, 2640, 1125, 148500000L, 0x17, 528, 44, 148, 4, 5,
	 36, PROG, Vpos, Hpos},
	/* 1920x1080@50Hz */
	{32, 0, 1920, 1080, 2750, 1125, 74250000L, 0x2E, 638, 44, 148, 4, 5, 36,
	 PROG, Vpos, Hpos},
	/* 1920x1080@24Hz */
	{33, 0, 1920, 1080, 2640, 1125, 74250000L, 0x2E, 528, 44, 148, 4, 5, 36,
	 PROG, Vpos, Hpos},
	/* 1920x1080@25Hz */
	{34, 0, 1920, 1080, 2200, 1125, 74250000L, 0x2E, 88, 44, 148, 4, 5, 36,
	 PROG, Vpos, Hpos},
	/* 1920x1080@30Hz */

	{35, 2, 2880, 480, 1716 * 2, 525, 108000000L, 0x20, 32 * 2, 124 * 2,
	 120 * 2, 9, 6, 30, PROG, Vneg, Hneg},
	/* 2880x480@60Hz */
	{36, 2, 2880, 480, 1716 * 2, 525, 108000000L, 0x20, 32 * 2, 124 * 2,
	 120 * 2, 9, 6, 30, PROG, Vneg, Hneg},
	/* 2880x480@60Hz */
	{37, 1, 2880, 576, 3456, 625, 108000000L, 0x20, 24 * 2, 128 * 2,
	 136 * 2, 5, 5, 39, PROG, Vneg, Hneg},
	/* 2880x576@50Hz */
	{38, 2, 2880, 576, 3456, 625, 108000000L, 0x20, 24 * 2, 128 * 2,
	 136 * 2, 5, 5, 39, PROG, Vneg, Hneg},
	/* 2880x576@50Hz */

	{39, 0, 1920, 540, 2304, 625, 72000000L, 0x17, 32, 168, 184, 23, 5, 57,
	 INTERLACE, Vneg, Hpos},
	/* 1920x1080@50Hz */
	/* 100Hz */
	{40, 0, 1920, 540, 2640, 562, 148500000L, 0x17, 528, 44, 148, 2, 5, 15,
	 INTERLACE, Vpos, Hpos},
	/* 1920x1080(I)@100Hz */
	{41, 0, 1280, 720, 1980, 750, 148500000L, 0x17, 440, 40, 220, 5, 5, 20,
	 PROG, Vpos, Hpos},
	/* 1280x720@100Hz */
	{42, 0, 720, 576, 864, 625, 54000000L, 0x40, 12, 64, 68, 5, 5, 39, PROG,
	 Vneg, Hneg},
	/* 720x576@100Hz */
	{43, 0, 720, 576, 864, 625, 54000000L, 0x40, 12, 64, 68, 5, 5, 39, PROG,
	 Vneg, Hneg},
	/* 720x576@100Hz */
	{44, 1, 720, 288, 864, 312, 27000000L, 0x80, 12, 63, 69, 2, 3, 19,
	 INTERLACE, Vneg, Hneg},
	/* 1440x576(I)@100Hz */
	{45, 1, 720, 288, 864, 312, 27000000L, 0x80, 12, 63, 69, 2, 3, 19,
	 INTERLACE, Vneg, Hneg},
	/* 1440x576(I)@100Hz */
	/* 120Hz */
	{46, 0, 1920, 540, 2200, 562, 148500000L, 0x17, 88, 44, 148, 2, 5, 15,
	 INTERLACE, Vpos, Hpos},
	/* 1920x1080(I)@120Hz */
	{47, 0, 1280, 720, 1650, 750, 148500000L, 0x17, 110, 40, 220, 5, 5, 20,
	 PROG, Vpos, Hpos},
	/* 1280x720@120Hz */
	{48, 0, 720, 480, 858, 525, 54000000L, 0x40, 16, 62, 60, 9, 6, 30, PROG,
	 Vneg, Hneg},
	/* 720x480@120Hz */
	{49, 0, 720, 480, 858, 525, 54000000L, 0x40, 16, 62, 60, 9, 6, 30, PROG,
	 Vneg, Hneg},
	/* 720x480@120Hz */
	{50, 1, 720, 240, 858, 262, 27000000L, 0x80, 19, 62, 57, 4, 3, 15,
	 INTERLACE, Vneg, Hneg},
	/* 720x480(I)@120Hz */
	{51, 1, 720, 240, 858, 262, 27000000L, 0x80, 19, 62, 57, 4, 3, 15,
	 INTERLACE, Vneg, Hneg},
	/* 720x480(I)@120Hz */

	/* 200Hz */
	{52, 0, 720, 576, 864, 625, 108000000L, 0x20, 12, 64, 68, 5, 5, 39,
	 PROG, Vneg, Hneg},
	/* 720x576@200Hz */
	{53, 0, 720, 576, 864, 625, 108000000L, 0x20, 12, 64, 68, 5, 5, 39,
	 PROG, Vneg, Hneg},
	/* 720x576@200Hz */
	{54, 1, 720, 288, 864, 312, 54000000L, 0x40, 12, 63, 69, 2, 3, 19,
	 INTERLACE, Vneg, Hneg},
	/* 1440x576(I)@200Hz */
	{55, 1, 720, 288, 864, 312, 54000000L, 0x40, 12, 63, 69, 2, 3, 19,
	 INTERLACE, Vneg, Hneg},
	/* 1440x576(I)@200Hz */
	/* 240Hz */
	{56, 0, 720, 480, 858, 525, 108000000L, 0x20, 16, 62, 60, 9, 6, 30,
	 PROG, Vneg, Hneg},
	/* 720x480@120Hz */
	{57, 0, 720, 480, 858, 525, 108000000L, 0x20, 16, 62, 60, 9, 6, 30,
	 PROG, Vneg, Hneg},
	/* 720x480@120Hz */
	{58, 1, 720, 240, 858, 262, 54000000L, 0x40, 19, 62, 57, 4, 3, 15,
	 INTERLACE, Vneg, Hneg},
	/* 720x480(I)@120Hz */
	{59, 1, 720, 240, 858, 262, 54000000L, 0x40, 19, 62, 57, 4, 3, 15,
	 INTERLACE, Vneg, Hneg},
	/* 720x480(I)@120Hz */
	/* 720p low resolution */
	{60, 0, 1280, 720, 3300, 750, 59400000L, 0x3A, 1760, 40, 220, 5, 5, 20,
	 PROG, Vpos, Hpos},
	/* 1280x720@24Hz */
	{61, 0, 1280, 720, 3960, 750, 74250000L, 0x2E, 2420, 40, 220, 5, 5, 20,
	 PROG, Vpos, Hpos},
	/* 1280x720@25Hz */
	{62, 0, 1280, 720, 3300, 750, 74250000L, 0x2E, 1760, 40, 220, 5, 5, 20,
	 PROG, Vpos, Hpos},
	/* 1280x720@30Hz */
	/* 1080p high refresh rate */
	{63, 0, 1920, 1080, 2200, 1125, 297000000L, 0x0B, 88, 44, 148, 4, 5, 36,
	 PROG, Vpos, Hpos},
	/* 1920x1080@120Hz */
	{64, 0, 1920, 1080, 2640, 1125, 297000000L, 0x0B, 528, 44, 148, 4, 5,
	 36, PROG, Vpos, Hpos},
	/* 1920x1080@100Hz */
	/* VESA mode */
	{0, 0, 640, 350, 832, 445, 31500000L, 0x6D, 32, 64, 96, 32, 3, 60, PROG,
	 Vneg, Hpos},
	/* 640x350@85 */
	{0, 0, 640, 400, 832, 445, 31500000L, 0x6D, 32, 64, 96, 1, 3, 41, PROG,
	 Vneg, Hneg},
	/* 640x400@85 */
	{0, 0, 832, 624, 1152, 667, 57283000L, 0x3C, 32, 64, 224, 1, 3, 39,
	 PROG, Vneg, Hneg},
	/* 832x624@75Hz */
	{0, 0, 720, 350, 900, 449, 28322000L, 0x7A, 18, 108, 54, 59, 2, 38,
	 PROG, Vneg, Hneg},
	/* 720x350@70Hz */
	{0, 0, 720, 400, 900, 449, 28322000L, 0x7A, 18, 108, 54, 13, 2, 34,
	 PROG, Vpos, Hneg},
	/* 720x400@70Hz */
	{0, 0, 720, 400, 936, 446, 35500000L, 0x61, 36, 72, 108, 1, 3, 42, PROG,
	 Vpos, Hneg},
	/* 720x400@85 */
	{0, 0, 640, 480, 800, 525, 25175000L, 0x89, 16, 96, 48, 10, 2, 33, PROG,
	 Vneg, Hneg},
	/* 640x480@60 */
	{0, 0, 640, 480, 832, 520, 31500000L, 0x6D, 24, 40, 128, 9, 3, 28, PROG,
	 Vneg, Hneg},
	/* 640x480@72 */
	{0, 0, 640, 480, 840, 500, 31500000L, 0x6D, 16, 64, 120, 1, 3, 16, PROG,
	 Vneg, Hneg},
	/* 640x480@75 */
	{0, 0, 640, 480, 832, 509, 36000000L, 0x60, 56, 56, 80, 1, 3, 25, PROG,
	 Vneg, Hneg},
	/* 640x480@85 */
	{0, 0, 800, 600, 1024, 625, 36000000L, 0x60, 24, 72, 128, 1, 2, 22,
	 PROG, Vpos, Hpos},
	/* 800x600@56 */
	{0, 0, 800, 600, 1056, 628, 40000000L, 0x56, 40, 128, 88, 1, 4, 23,
	 PROG, Vpos, Hpos},
	/* 800x600@60 */
	{0, 0, 800, 600, 1040, 666, 50000000L, 0x45, 56, 120, 64, 37, 6, 23,
	 PROG, Vpos, Hpos},
	/* 800x600@72 */
	{0, 0, 800, 600, 1056, 625, 49500000L, 0x45, 16, 80, 160, 1, 3, 21,
	 PROG, Vpos, Hpos},
	/* 800x600@75 */
	{0, 0, 800, 600, 1048, 631, 56250000L, 0x3D, 32, 64, 152, 1, 3, 27,
	 PROG, Vpos, Hpos},
	/* 800X600@85 */
	{0, 0, 848, 480, 1088, 517, 33750000L, 0x66, 16, 112, 112, 6, 8, 23,
	 PROG, Vpos, Hpos},
	/* 840X480@60 */
	{0, 0, 1024, 384, 1264, 408, 44900000L, 0x4C, 8, 176, 56, 0, 4, 20,
	 INTERLACE, Vpos, Hpos},
	/* 1024x768(I)@87Hz */
	{0, 0, 1024, 768, 1344, 806, 65000000L, 0x35, 24, 136, 160, 3, 6, 29,
	 PROG, Vneg, Hneg},
	/* 1024x768@60 */
	{0, 0, 1024, 768, 1328, 806, 75000000L, 0x2E, 24, 136, 144, 3, 6, 29,
	 PROG, Vneg, Hneg},
	/* 1024x768@70 */
	{0, 0, 1024, 768, 1312, 800, 78750000L, 0x2B, 16, 96, 176, 1, 3, 28,
	 PROG, Vpos, Hpos},
	/* 1024x768@75 */
	{0, 0, 1024, 768, 1376, 808, 94500000L, 0x24, 48, 96, 208, 1, 3, 36,
	 PROG, Vpos, Hpos},
	/* 1024x768@85 */
	{0, 0, 1152, 864, 1600, 900, 108000000L, 0x20, 64, 128, 256, 1, 3, 32,
	 PROG, Vpos, Hpos},
	/* 1152x864@75 */
	{0, 0, 1280, 768, 1440, 790, 68250000L, 0x32, 48, 32, 80, 3, 7, 12,
	 PROG, Vneg, Hpos},
	/* 1280x768@60-R */
	{0, 0, 1280, 768, 1664, 798, 79500000L, 0x2B, 64, 128, 192, 3, 7, 20,
	 PROG, Vpos, Hneg},
	/* 1280x768@60 */
	{0, 0, 1280, 768, 1696, 805, 102250000L, 0x21, 80, 128, 208, 3, 7, 27,
	 PROG, Vpos, Hneg},
	/* 1280x768@75 */
	{0, 0, 1280, 768, 1712, 809, 117500000L, 0x1D, 80, 136, 216, 3, 7, 31,
	 PROG, Vpos, Hneg},
	/* 1280x768@85 */

	{0, 0, 1280, 800, 1440, 823, 71000000L, 0x31, 48, 32, 80, 3, 6, 14,
	 PROG, Vpos, Hneg},
	/* 1280x800@60Hz */
	{0, 0, 1280, 800, 1680, 831, 83500000L, 0x29, 72, 128, 200, 3, 6, 22,
	 PROG, Vpos, Hneg},
	/* 1280x800@60Hz */
	{0, 0, 1280, 800, 1696, 838, 106500000L, 0x20, 80, 128, 208, 3, 6, 29,
	 PROG, Vpos, Hneg},
	/* 1280x800@75Hz */
	{0, 0, 1280, 800, 1712, 843, 122500000L, 0x1C, 80, 136, 216, 3, 6, 34,
	 PROG, Vpos, Hneg},
	/* 1280x800@85Hz */

	{0, 0, 1280, 960, 1800, 1000, 108000000L, 0x20, 96, 112, 312, 1, 3, 36,
	 PROG, Vpos, Hpos},
	/* 1280x960@60 */
	{0, 0, 1280, 960, 1728, 1011, 148500000L, 0x17, 64, 160, 224, 1, 3, 47,
	 PROG, Vpos, Hpos},
	/* 1280x960@85 */
	{0, 0, 1280, 1024, 1688, 1066, 108000000L, 0x20, 48, 112, 248, 1, 3, 38,
	 PROG, Vpos, Hpos},
	/* 1280x1024@60 */
	{0, 0, 1280, 1024, 1688, 1066, 135000000L, 0x19, 16, 144, 248, 1, 3, 38,
	 PROG, Vpos, Hpos},
	/* 1280x1024@75 */
	{0, 0, 1280, 1024, 1728, 1072, 157500000L, 0x15, 64, 160, 224, 1, 3, 44,
	 PROG, Vpos, Hpos},
	/* 1280X1024@85 */
	{0, 0, 1360, 768, 1792, 795, 85500000L, 0x28, 64, 112, 256, 3, 6, 18,
	 PROG, Vpos, Hpos},
	/* 1360X768@60 */

	{0, 0, 1366, 768, 1792, 798, 85500000L, 0x28, 70, 143, 213, 3, 3, 24,
	 PROG, Vpos, Hpos},
	/* 1366X768@60 */
	{0, 0, 1366, 768, 1500, 800, 72000000L, 0x30, 14, 56, 64, 1, 3, 28,
	 PROG, Vpos, Hpos},
	/* 1360X768@60 */
	{0, 0, 1400, 1050, 1560, 1080, 101000000L, 0x22, 48, 32, 80, 3, 4, 23,
	 PROG, Vneg, Hpos},
	/* 1400x768@60-R */
	{0, 0, 1400, 1050, 1864, 1089, 121750000L, 0x1C, 88, 144, 232, 3, 4, 32,
	 PROG, Vpos, Hneg},
	/* 1400x768@60 */
	{0, 0, 1400, 1050, 1896, 1099, 156000000L, 0x16, 104, 144, 248, 3, 4,
	 42, PROG, Vpos, Hneg},
	/* 1400x1050@75 */
	{0, 0, 1400, 1050, 1912, 1105, 179500000L, 0x13, 104, 152, 256, 3, 4,
	 48, PROG, Vpos, Hneg},
	/* 1400x1050@85 */
	{0, 0, 1440, 900, 1600, 926, 88750000L, 0x26, 48, 32, 80, 3, 6, 17,
	 PROG, Vneg, Hpos},
	/* 1440x900@60-R */
	{0, 0, 1440, 900, 1904, 934, 106500000L, 0x20, 80, 152, 232, 3, 6, 25,
	 PROG, Vpos, Hneg},
	/* 1440x900@60 */
	{0, 0, 1440, 900, 1936, 942, 136750000L, 0x19, 96, 152, 248, 3, 6, 33,
	 PROG, Vpos, Hneg},
	/* 1440x900@75 */
	{0, 0, 1440, 900, 1952, 948, 157000000L, 0x16, 104, 152, 256, 3, 6, 39,
	 PROG, Vpos, Hneg},
	/* 1440x900@85 */
	{0, 0, 1600, 1200, 2160, 1250, 162000000L, 0x15, 64, 192, 304, 1, 3, 46,
	 PROG, Vpos, Hpos},
	/* 1600x1200@60 */
	{0, 0, 1600, 1200, 2160, 1250, 175500000L, 0x13, 64, 192, 304, 1, 3, 46,
	 PROG, Vpos, Hpos},
	/* 1600x1200@65 */
	{0, 0, 1600, 1200, 2160, 1250, 189000000L, 0x12, 64, 192, 304, 1, 3, 46,
	 PROG, Vpos, Hpos},
	/* 1600x1200@70 */
	{0, 0, 1600, 1200, 2160, 1250, 202500000L, 0x11, 64, 192, 304, 1, 3, 46,
	 PROG, Vpos, Hpos},
	/* 1600x1200@75 */
	{0, 0, 1600, 1200, 2160, 1250, 229500000L, 0x0F, 64, 192, 304, 1, 3, 46,
	 PROG, Vpos, Hpos},
	/* 1600x1200@85 */
	{0, 0, 1680, 1050, 1840, 1080, 119000000L, 0x1D, 48, 32, 80, 3, 6, 21,
	 PROG, Vneg, Hpos},
	/* 1680x1050@60-R */
	{0, 0, 1680, 1050, 2240, 1089, 146250000L, 0x17, 104, 176, 280, 3, 6,
	 30, PROG, Vpos, Hneg},
	/* 1680x1050@60 */
	{0, 0, 1680, 1050, 2272, 1099, 187000000L, 0x12, 120, 176, 296, 3, 6,
	 40, PROG, Vpos, Hneg},
	/* 1680x1050@75 */
	{0, 0, 1680, 1050, 2288, 1105, 214750000L, 0x10, 128, 176, 304, 3, 6,
	 46, PROG, Vpos, Hneg},
	/* 1680x1050@85 */
	{0, 0, 1792, 1344, 2448, 1394, 204750000L, 0x10, 128, 200, 328, 1, 3,
	 46, PROG, Vpos, Hneg},
	/* 1792x1344@60 */
	{0, 0, 1792, 1344, 2456, 1417, 261000000L, 0x0D, 96, 216, 352, 1, 3, 69,
	 PROG, Vpos, Hneg},
	/* 1792x1344@75 */
	{0, 0, 1856, 1392, 2528, 1439, 218250000L, 0x0F, 96, 224, 352, 1, 3, 43,
	 PROG, Vpos, Hneg},
	/* 1856x1392@60 */
	{0, 0, 1856, 1392, 2560, 1500, 288000000L, 0x0C, 128, 224, 352, 1, 3,
	 104, PROG, Vpos, Hneg},

	/* 1856x1392@75 */
	{0, 0, 1920, 1200, 2080, 1235, 154000000L, 0x16, 48, 32, 80, 3, 6, 26,
	 PROG, Vneg, Hpos},
	/* 1920x1200@60-R */
	{0, 0, 1920, 1200, 2592, 1245, 193250000L, 0x11, 136, 200, 336, 3, 6,
	 36, PROG, Vpos, Hneg},
	/* 1920x1200@60 */
	{0, 0, 1920, 1200, 2608, 1255, 245250000L, 0x0E, 136, 208, 344, 3, 6,
	 46, PROG, Vpos, Hneg},
	/* 1920x1200@75 */
	{0, 0, 1920, 1200, 2624, 1262, 281250000L, 0x0C, 144, 208, 352, 3, 6,
	 53, PROG, Vpos, Hneg},
	/* 1920x1200@85 */
	{0, 0, 1920, 1440, 2600, 1500, 234000000L, 0x0E, 128, 208, 344, 1, 3,
	 56, PROG, Vpos, Hneg},
	/* 1920x1440@60 */
	{0, 0, 1920, 1440, 2640, 1500, 297000000L, 0x0B, 144, 224, 352, 1, 3,
	 56, PROG, Vpos, Hneg},
	/* 1920x1440@75 */
};
...
void HDMITX_SetOutput(void)
{
	...
	if (InstanceData.bInputVideoSignalType & T_MODE_SYNCEMB)
		setHDMITX_SyncEmbeddedByVIC(VIC,
					    InstanceData.bInputVideoSignalType);

#endif

	HDMITX_DEBUG_PRINTF(
		"level = %d, ,bInputColorMode=%x,bOutputColorMode=%x,bHDMIMode=%x\n",
		(int)level, (int)bInputColorMode, (int)bOutputColorMode,
		(int)bHDMIMode);
	HDMITX_EnableVideoOutput(level, bInputColorMode, bOutputColorMode,
				 bHDMIMode);
			      ...
			      unsigned char AudioFs)
{
	...
	HDMITX_DEBUG_PRINTF(
		"%s():bOutputAudioType = %02X, ulAudioSampleFS = %8ld, bOutputAudioChannel = %d\n",
		__func__, (int)bOutputAudioType, ulAudioSampleFS,
...
{
	HDMITX_DEBUG_PRINTF("%s: %d\n", __func__, bAudioEnable);
	if (bAudioEnable) {
		ConfigAudioInfoFrm();
		/* HDMITX_EnableAudioOutput(T_AUDIO_LPCM, FALSE,
		 * ulAudioSampleFS,OUTPUT_CHANNEL,NULL,TMDSClock);
		...
		HDMITX_EnableAudioOutput(
			...
			bOutputAudioType, CONFIG_INPUT_AUDIO_SPDIF,
			ulAudioSampleFS, bOutputAudioChannel, NULL,
...
#ifdef IT6615
				if (RxCapability.dc.uc &
				    (HDMI_DC_SUPPORT_36 | HDMI_DC_SUPPORT_30))
					setHDMITX_ColorDepthPhase(
						OutputColorDepth, 0);
				else
...
/* HDMITX_DisableVideoOutput(); */
			...
			/* unplug mode, ... */
			HDMITX_DEBUG_PRINTF(
				"HPD OFF HDMITX_DisableVideoOutput()\n");
			HDMITX_DisableVideoOutput();
			HDMITX_PowerDown();
...
void HDMITX_MonitorInputAudioChange(void)
{
	...
	if (!bAudioEnable) {
		...
		AudioFS = CalcAudFS();
		HDMITX_DEBUG_PRINTF1(
			("Audio Chagne, Audio clock = %ldHz\n", AudioFS));
		if (AudioFS > 188000L) {
			/* 192KHz */
			ulAudioSampleFS = 192000L;
		...
		if (!it66121_bChangeMode) {
			if (ulAudioSampleFS != prevAudioSampleFS) {
				HDMITX_DEBUG_PRINTF(
					"ulAudioSampleFS = %ldHz -> %ldHz\n",
					ulAudioSampleFS, ulAudioSampleFS);
				ConfigAudioInfoFrm();
				HDMITX_EnableAudioOutput(
					CNOFIG_INPUT_AUDIO_TYPE,
					CONFIG_INPUT_AUDIO_SPDIF,
					ulAudioSampleFS, OUTPUT_CHANNEL, NULL,
					0);
				/* HDMITX_EnableAudioOutput(T_AUDIO_LPCM,*/
				/* FALSE,
				 * ulAudioSampleFS,OUTPUT_CHANNEL,NULL,0);
				 */
			}
		}
...
int HDMITX_SearchVICIndex(ULONG PCLK, unsigned short HTotal,
			  unsigned short VTotal, unsigned char ScanMode)
{
#define SEARCH_COUNT 4
		...
		if (ScanMode == s_VMTable[i].ScanMode) {
			...
			if (hit == 2) {
				...
				if (DIFF(HTotal, s_VMTable[i].HTotal) < 40) {
					...
					pclkDiff =
						DIFF(PCLK, s_VMTable[i].PCLK);
					pclkDiff = (pclkDiff * 100) /
						   s_VMTable[i].PCLK;
	...
	if (hit > 2) {
		...
		HDMITX_DEBUG_PRINTF((">> mode : %d %u x %u @%lu (%s)\n",
				     (int)s_VMTable[i].VIC,
				     s_VMTable[i].HActive, s_VMTable[i].VActive,
				     s_VMTable[i].PCLK,
...
void HDMITX_MonitorInputVideoChange(void)
{
	...
	HDMITX_DEBUG_PRINTF((
		"%s : pclk=%lu, ht=%u, vt=%u, dif=%lu\n",
		__func__, currPCLK, currHTotal, currVTotal, diff));
...
#if 0
		for (i = 0; (i < SizeofVMTable) && (s_VMTable[i].VIC != 0);
		 i++) {
			if (s_VMTable[i].VIC == 0)
				break;
			if (DIFF(currPCLK, s_VMTable[i].PCLK) >
				(s_VMTable[i].PCLK / 20))
				continue;
			...
			if (currScanMode == INTERLACE) {
				if (DIFF(currVTotal / 2,
					s_VMTable[i].VTotal) > 10)
					continue;
...
#else
		i = HDMITX_SearchVICIndex(currPCLK, currHTotal, currVTotal,
					  currScanMode);
#endif
...
void ConfigAVIInfoFrame(unsigned char VIC, unsigned char pixelrep)
{
	...
	AviInfo->pktbyte.AVI_DB[1] |=
		(aspec != HDMI_16x9) ? (1 << 4) : (2 << 4); /* 4:3 or 16:9 */
	AviInfo->pktbyte.AVI_DB[1] |= (Colorimetry != HDMI_ITU709)
					      ? (1 << 6)
					      : (2 << 6); /* 4:3 or 16:9 */
...
unsigned char ParseEDID(void)
{
	...
	for (i = 1; i <= BlockCount; i++) {
		...
		for (j = 0; j < 128; j++)
			EDID_DEBUG_PRINTF1("%02X%c", (int)EDID_Buf[j],
					   (7 == (i & 7)) ? '\n' : ' ');

		if (err) {
			if (!bValidCEA && EDID_Buf[0] == 0x2 &&
			    EDID_Buf[1] == 0x3) {
...
bool ParseCEAEDID(unsigned char *pCEAEDID)
{
	...
	for (offset = 4; offset < End;) {
		...
		case 0x02: /* Video Data Block ; */
			offset++;
			for (i = 0, RxCapability.NativeVDOMode = 0xff;
			     i < count; i++) {
				unsigned char VIC;
		...
		case 0x03: /* Vendor Specific Data Block ; */
			...
			EDID_DEBUG_PRINTF("IEEEOUI = %02X %02X %02X %lx",
					  (int)pCEAEDID[offset + 2],
					  (int)pCEAEDID[offset + 1],
					  (int)pCEAEDID[offset],
					  RxCapability.IEEEOUI);
			if (RxCapability.IEEEOUI == 0x0C03) {
				...
				if (count > 5)
					RxCapability.dc.uc =
						pCEAEDID[offset + 5] & 0x70;

				if (count > 6)
					RxCapability.MaxTMDSClock =
						pCEAEDID[offset + 6];
