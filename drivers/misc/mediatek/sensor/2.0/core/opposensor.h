...
#define SENSOR_TYPE_OPPO_ACTIVITY_RECOGNITION          (OPLUS_VIRTAUL_SENSOR_START + 7)
/* end sensor type */
#define SENSOR_TYPE_SENSOR_MAX                         (SENSOR_TYPE_OPPO_ACTIVITY_RECOGNITION +1)
...
/* end sensor ID */
#define ID_SENSOR_MAX    (ID_OPPO_ACTIVITY_RECOGNITION + 1)
typedef struct {
    uint32_t value;
