...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	{6560, 4928, 0,  16, 6560, 4896, 3280, 2448,  8,   0, 3264, 2448,  0,  0, 3264, 2448}, /* Preview */
	{6560, 4928, 0,  16, 6560, 4896, 3280, 2448,  8,   0, 3264, 2448,  0,  0, 3264, 2448}, /* capture */
	{6560, 4928, 0,  16, 6560, 4896, 3280, 2448,  8,   0, 3264, 2448,  0,  0, 3264, 2448}, /* normal video */
	{6560, 4928, 0,  16, 6560, 4896, 3280, 2448,  8,   0, 3264, 2448,  0,  0, 3264, 2448}, /* hs_video */
	{6560, 4928, 0,  16, 6560, 4896, 3280, 2448,  8,   0, 3264, 2448,  0,  0, 3264, 2448}, /* slim video */
	{6560, 4928, 0, 736, 6560, 3456, 3280, 1728, 488,  0, 2304, 1728,  0,  0, 2304, 1728}, /* custom1 */
	{6560, 4928, 0,   0, 6560, 4928, 3280, 2464,  0,   0, 3280, 2464,  0,  0, 3280, 2464}, /* custom2 */
...
static kal_uint16 imx616_custom2_setting[] = {
	//MIPI output setting
	0x0112,0x0A,
	0x0113,0x0A,
	0x0114,0x03,
...
static kal_uint16 imx616_custom3_setting[] = {
	//MIPI output setting
	0x0112,0x0A,
	0x0113,0x0A,
	0x0114,0x03,
...
static void custom2_setting(void)
{
	LOG_INF("%s 16:9 E! currefps\n", __func__);
	/*************MIPI output setting************/
	imx616_table_write_cmos_sensor(imx616_custom2_setting,
		sizeof(imx616_custom2_setting)/sizeof(kal_uint16));
}
...
static void custom3_setting(void)
{
	LOG_INF("%s 16:9 E! currefps\n", __func__);
	/*************MIPI output setting************/
	imx616_table_write_cmos_sensor(imx616_custom3_setting,
		sizeof(imx616_custom3_setting)/sizeof(kal_uint16));
}
