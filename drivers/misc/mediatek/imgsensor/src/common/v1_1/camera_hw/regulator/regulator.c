...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
	if (is_project(20609) || is_project(0x2060A) || is_project(0x2060B) || is_project(0x206F0) || is_project(0x206FF) || is_project(20795) || is_project(20796) || is_project(0x2070C) || is_project(0x2070B) || is_project(0x2070E))
	{
