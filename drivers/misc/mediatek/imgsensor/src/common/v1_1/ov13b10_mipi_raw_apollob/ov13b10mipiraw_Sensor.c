...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10_SENSOR_ID_APOLLOB,
...
kal_uint16 addr_data_pair_init_apollob_ov13b10[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_init_apollob_ov13b10,
			   sizeof(addr_data_pair_init_apollob_ov13b10) / sizeof(kal_uint16));
#endif
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_apollob_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_preview_apollob_ov13b10,
				   sizeof(addr_data_pair_preview_apollob_ov13b10) / sizeof(kal_uint16));
#endif
}	/*	preview_setting  */
/*************************************************************************
* FUNCTION
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_setting_apollob_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_setting_apollob_ov13b10,
		sizeof(addr_data_pair_capture_setting_apollob_ov13b10) /
		sizeof(kal_uint16));
#endif
}
...
kal_uint16 addr_data_pair_normal_video_setting_apollob_ov13b10[] = {
	0x0100, 0x00,
...
{
	#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_normal_video_setting_apollob_ov13b10,
				   sizeof(addr_data_pair_normal_video_setting_apollob_ov13b10) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_slim_video_setting_apollob_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x23,
	0x0327, 0x04,
...
{
	#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_slim_video_setting_apollob_ov13b10,
				   sizeof(addr_data_pair_slim_video_setting_apollob_ov13b10) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_hs_video_setting_apollob_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x23,
	0x0327, 0x04,
...
{
	#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_hs_video_setting_apollob_ov13b10,
				   sizeof(addr_data_pair_hs_video_setting_apollob_ov13b10) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_custom1_apollob_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void custom1_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom1_apollob_ov13b10,
				   sizeof(addr_data_pair_custom1_apollob_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}
kal_uint16 addr_data_pair_custom2_apollob_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x4b,
	0x0327, 0x05,
...
static void custom2_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom2_apollob_ov13b10,
				   sizeof(addr_data_pair_custom2_apollob_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}
kal_uint16 addr_data_pair_custom3_apollob_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void custom3_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom3_apollob_ov13b10,
				   sizeof(addr_data_pair_custom3_apollob_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}


kal_uint16 addr_data_pair_custom4_apollob_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void custom4_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom4_apollob_ov13b10,
				   sizeof(addr_data_pair_custom4_apollob_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}
