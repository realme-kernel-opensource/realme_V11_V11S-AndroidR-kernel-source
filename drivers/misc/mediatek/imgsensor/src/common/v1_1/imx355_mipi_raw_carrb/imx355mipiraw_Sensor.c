...
static kal_uint8 EepData[DUALCAM_CALI_DATA_LENGTH + CAMERA_MODULE_SN_LENGTH + CAMERA_MODULE_INFO_LENGTH];

#endif
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = CARRB_IMX355_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
	...
	{3280, 2464,   8,   8,   3264, 2448, 1632, 1224,   0,   0, 1632, 1224, 0, 0, 1632, 1224},//custom2
	...
	{3280, 2464,   8,   8,   3264, 2448, 1632, 1224,   0,   0, 1632, 1224, 0, 0, 1632, 1224},//custom5
};
...
UINT32 CARRB_IMX355_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
