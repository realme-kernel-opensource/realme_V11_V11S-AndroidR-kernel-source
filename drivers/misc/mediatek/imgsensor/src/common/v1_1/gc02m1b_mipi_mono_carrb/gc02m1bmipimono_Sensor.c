...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = CARRB_GC02M1B_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
kal_uint16 addr_data_pair_init_carrb_gc02m1b[] = {
/*system*/
0xfc,0x01,
0xf4,0x41,
0xf5,0xc0,
...
kal_uint16 addr_data_pair_preview_carrb_gc02m1b[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_carrb_gc02m1b[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_carrb_gc02m1b[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_carrb_gc02m1b[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_carrb_gc02m1b[] = {
    0xfe, 0x00,
    0x3e, 0x90,
};
static void sensor_init(void)
{
    ...
    table_write_cmos_sensor(addr_data_pair_init_carrb_gc02m1b,
        sizeof(addr_data_pair_init_carrb_gc02m1b) / sizeof(kal_uint16));
...
UINT32 CARRB_GC02M1B_MIPI_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
