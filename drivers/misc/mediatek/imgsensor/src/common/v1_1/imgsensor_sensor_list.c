...
{T8EV5_SENSOR_ID, SENSOR_DRVNAME_T8EV5_YUV, T8EV5_YUV_SensorInit},
	...
	{CARR_OV13B10_SENSOR_ID, SENSOR_DRVNAME_OV13B10_MIPI_RAW_CARR,
		CARR_OV13B10_MIPI_RAW_SensorInit},
#endif
#if defined(OV13B10_MIPI_RAW_CARRB)
	{CARRB_OV13B10_SENSOR_ID, SENSOR_DRVNAME_OV13B10_MIPI_RAW_CARRB,
		CARRB_OV13B10_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3L6_MIPI_RAW_CARR)
	{CARR_S5K3L6_SENSOR_ID, SENSOR_DRVNAME_S5K3L6_MIPI_RAW_CARR,
		CARR_S5K3L6_MIPI_RAW_SensorInit},
#endif
#if defined(IMX355_MIPI_RAW_CARR)
	{CARR_IMX355_SENSOR_ID, SENSOR_DRVNAME_IMX355_MIPI_RAW_CARR,
		CARR_IMX355_MIPI_RAW_SensorInit},
#endif
#if defined(IMX355_MIPI_RAW_CARRB)
	{CARRB_IMX355_SENSOR_ID, SENSOR_DRVNAME_IMX355_MIPI_RAW_CARRB,
		CARRB_IMX355_MIPI_RAW_SensorInit},
#endif
#if defined(GC02M1B_MIPI_MONO_CARR)
	{CARR_GC02M1B_SENSOR_ID, SENSOR_DRVNAME_GC02M1B_MIPI_MONO_CARR,
		CARR_GC02M1B_MIPI_MONO_SensorInit},
#endif
#if defined(GC02M1B_MIPI_MONO_CARRB)
	{CARRB_GC02M1B_SENSOR_ID, SENSOR_DRVNAME_GC02M1B_MIPI_MONO_CARRB,
		CARRB_GC02M1B_MIPI_MONO_SensorInit},
#endif
#if defined(OV02B10_MIPI_RAW_CARR)
	{CARR_OV02B10_SENSOR_ID, SENSOR_DRVNAME_OV02B10_MIPI_RAW_CARR,
		CARR_OV02B10_MIPI_RAW_SensorInit},
#endif
#if defined(GC02M1_MIPI_RAW_CARR)
	{CARR_GC02M1_SENSOR_ID, SENSOR_DRVNAME_GC02M1_MIPI_RAW_CARR,
		CARR_GC02M1_MIPI_RAW_SensorInit},
#endif
#if defined(S5KGM1ST_MIPI_RAW_APOLLOB)
	{S5KGM1ST_SENSOR_ID_APOLLOB, SENSOR_DRVNAME_S5KGM1ST_MIPI_RAW_APOLLOB,
		S5KGM1ST_MIPI_RAW_APOLLOB_SensorInit},
#endif
#if defined(IMX355_MIPI_RAW_APOLLOB)
	{IMX355_SENSOR_ID_APOLLOB, SENSOR_DRVNAME_IMX355_MIPI_RAW_APOLLOB,
		IMX355_MIPI_RAW_APOLLOB_SensorInit},
#endif
#if defined(GC02M1B_MIPI_MONO_APOLLOB)
	{GC02M1B_SENSOR_ID_APOLLOB, SENSOR_DRVNAME_GC02M1B_MIPI_MONO_APOLLOB,
		GC02M1B_MIPI_MONO_APOLLOB_SensorInit},
#endif

#if defined(OV02B10_MIPI_RAW_APOLLOB)
	{OV02B10_SENSOR_ID_APOLLOB, SENSOR_DRVNAME_OV02B10_MIPI_RAW_APOLLOB,
		OV02B10_MIPI_RAW_APOLLOB_SensorInit},
#endif
#if defined(S5K3P9SP_MIPI_RAW_APOLLOB)
	{S5K3P9SP_SENSOR_ID_APOLLOB, SENSOR_DRVNAME_S5K3P9SP_MIPI_RAW_APOLLOB,
		S5K3P9SP_MIPI_RAW_APOLLOB_SensorInit},
#endif
#if defined(OV13B10_MIPI_RAW_APOLLOB)
	{OV13B10_SENSOR_ID_APOLLOB, SENSOR_DRVNAME_OV13B10_MIPI_RAW_APOLLOB,
		OV13B10_MIPI_RAW_APOLLOB_SensorInit},
#endif
