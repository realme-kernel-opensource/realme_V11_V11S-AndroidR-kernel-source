...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGM1ST_SENSOR_ID_APOLLOB,
...
static kal_uint16 gm1st_slim_video_setting_2070C[] = {
	0x6028, 0x4000,
	0x6214, 0x7971,
	0x6218, 0x7150,
	0x0344, 0x0008,
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	if (IsProject_2070C) {
		table_write_cmos_sensor(gm1st_slim_video_setting_2070C,
			sizeof(gm1st_slim_video_setting_2070C)/sizeof(kal_uint16));
		printk("choose the project 2070C\n");
	} else {
		table_write_cmos_sensor(gm1st_slim_video_setting,
			sizeof(gm1st_slim_video_setting)/sizeof(kal_uint16));
		printk("choose the project 20609\n");
	}
	LOG_INF("X\n");
}
...
static kal_uint32 open(void)
{
	...
	#ifdef OPLUS_FEATURE_CAMERA_COMMON
	if(is_project(0x2070C)||is_project(0x206FF)){
		IsProject_2070C = true;
	}
	#endif
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_MIPI_PIXEL_RATE:
	{
		...
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			if (IsProject_2070C) {
				*(MUINT32 *)(uintptr_t)(*(feature_data + 1))
					= MIPI_PIXEL_RATE_2070C;
				pr_debug("The project is 2070C\n");
			} else {
				*(MUINT32 *)(uintptr_t)(*(feature_data + 1))
