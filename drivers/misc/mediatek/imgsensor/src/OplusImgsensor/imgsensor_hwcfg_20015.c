...
struct IMGSENSOR_SENSOR_LIST
    gimgsensor_sensor_list_21638[MAX_NUM_OF_SUPPORT_SENSOR] = {
#if defined(OV13B10_MIPI_RAW_CARRB)
	{CARRB_OV13B10_SENSOR_ID, SENSOR_DRVNAME_OV13B10_MIPI_RAW_CARRB, CARRB_OV13B10_MIPI_RAW_SensorInit},
#endif
#if defined(IMX355_MIPI_RAW_CARRB)
	{CARRB_IMX355_SENSOR_ID, SENSOR_DRVNAME_IMX355_MIPI_RAW_CARRB, CARRB_IMX355_MIPI_RAW_SensorInit},
#endif
#if defined(GC02M1B_MIPI_MONO_CARRB)
	{CARRB_GC02M1B_SENSOR_ID, SENSOR_DRVNAME_GC02M1B_MIPI_MONO_CARRB, CARRB_GC02M1B_MIPI_MONO_SensorInit},
#endif
    /* ADD sensor driver before this line */
    {0, {0}, NULL}, /* end of list */
};
...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence_21638[] = {
#if defined(OV13B10_MIPI_RAW_CARRB)
	{
		SENSOR_DRVNAME_OV13B10_MIPI_RAW_CARRB,
		{
			{RST, Vol_Low, 1},
			{AVDD, Vol_2800, 0},
			{DVDD, Vol_1200, 0},
...
#if defined(IMX355_MIPI_RAW_CARRB)
	{
		SENSOR_DRVNAME_IMX355_MIPI_RAW_CARRB,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{DVDD, Vol_1200, 1},
...
#if defined(GC02M1B_MIPI_MONO_CARRB)
	{
		SENSOR_DRVNAME_GC02M1B_MIPI_MONO_CARRB,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 0},
