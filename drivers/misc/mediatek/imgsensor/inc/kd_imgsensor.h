...
#define CARR_IMX355_SENSOR_ID                          0x0355
...
#define S5KGM1ST_SENSOR_ID_APOLLOB                     0xF8D2 // (0xF8D1 + 1)
#define IMX355_SENSOR_ID_APOLLOB                       0x356  // (0x355 + 1)
#define GC02M1B_SENSOR_ID_APOLLOB                      0x02e5 // (0x02e0 + 5)
#define OV02B10_SENSOR_ID_APOLLOB                      0x002D // (0x002B + 2)
...
#define S5K3P9SP_SENSOR_ID_APOLLOB                        0x3109
#define OV13B10_SENSOR_ID_APOLLOB                         0x560D44 // (0x560D42 + 2)
...
#define CARRB_OV13B10_SENSOR_ID                        0x560D45 // (0x560D42 + 3)
#define CARRB_IMX355_SENSOR_ID                         0x0357 // (0x0355 + 2)
#define CARRB_GC02M1B_SENSOR_ID                        0x02e6 // (0x02e0 + 6)
#define SENSOR_DRVNAME_OV13B10_MIPI_RAW_CARRB          "ov13b10_mipi_raw_carrb"
#define SENSOR_DRVNAME_IMX355_MIPI_RAW_CARRB           "imx355_mipi_raw_carrb"
#define SENSOR_DRVNAME_GC02M1B_MIPI_MONO_CARRB         "gc02m1b_mipi_mono_carrb"
