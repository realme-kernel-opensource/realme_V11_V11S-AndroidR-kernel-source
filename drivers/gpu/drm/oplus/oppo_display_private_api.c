        ...
        struct device_attribute *attr, const char *buf, size_t num)
{
	...
	if (cabc_mode == CABC_ENTER_SPECIAL) {
		...
		if (cabc_back_flag == CABC_LEVEL_0) {
			...
			if (is_project(20651) || is_project(20652) || is_project(21637) || is_project(21638) || is_project(20608) || is_project(20609) || is_project(0x2060A) || is_project(0x2060B) 
				|| is_project(0x206F0) || is_project(0x206FF) || is_project(0x2070B) || is_project(0x2070C) || is_project(0x2070E) || is_project(20796)) {
				disp_aal_set_dre_en(1);
			} else {
				disp_aal_set_dre_en(0);
