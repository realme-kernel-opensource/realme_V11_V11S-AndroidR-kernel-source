...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0x80,0xC0,0xAF,0xA3,0x9B,0x92,0x8D,0x8A,0x86,0x84,0x83,0x82,0x81,0x44,0x04,0xF6,0xCF);
	...
	lcm_dcs_write_seq_static(ctx, 0x41,0x5A, 0x24);
	lcm_dcs_write_seq_static(ctx, 0x80,0x00,0x03,0x00,0xFF,0xFF,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x71,0xCA);
		...
		void *handle)
{
	...
	bl_tb0[1] = esd_brightness >> 4;
	bl_tb0[2] = esd_brightness & 0x0F;
	if (!cb)
		return -1;
	pr_err("%s bl_tb0[1]=%x, bl_tb0[2]=%x\n", __func__, bl_tb0[1], bl_tb0[2]);
	cb(dsi, handle, bl_tb0, ARRAY_SIZE(bl_tb0));
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd","ft8006s","truly");
...
static const struct of_device_id jdi_of_match[] = {
	{
		.compatible = "truly,ft8006s,dphy,vdo",
	},
	{} };
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = lcm_remove,
	.driver = {
			.name = "oppo21637_ft8006s_truly_vdo_lcm_drv",
			.owner = THIS_MODULE,
