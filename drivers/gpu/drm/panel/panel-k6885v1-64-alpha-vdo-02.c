...
#endif
static int oppo_dc_alpha = 0;
static int oppo_dc_enable_real = 0;
static int oppo_dc_enable = 0;
unsigned int safe_mode = 2;
static unsigned long oppo_display_brightness;
static char send_cmd[RAMLESS_AOD_PAYLOAD_SIZE];
extern int __attribute__((weak)) oppo_seed_bright_to_alpha(int brightness) {return 0;};
static unsigned int aod_light_mode = 0;
...
static int panel_set_aod_light_mode(void *dsi, dcs_write_gce cb, void *handle)
{
	int i = 0;
		...
		void *handle, unsigned int level)
{
	...
	mapped_level = level /* oppo_lcm_dc_backlight(dsi,cb,handle, level, 0) */;
