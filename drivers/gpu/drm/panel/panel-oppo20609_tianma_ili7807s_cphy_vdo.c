...
extern int __attribute__((weak)) tp_control_reset_gpio(bool enable) {return 0;}
...
//add for cabc
	...
	tianma_dcs_write_seq_static(ctx, 0xFF, 0x78,0x07,0x03);
	tianma_dcs_write_seq_static(ctx, 0x88, 0xDB);
	tianma_dcs_write_seq_static(ctx, 0x89, 0xEA);
	tianma_dcs_write_seq_static(ctx, 0x8A, 0xEC);
	tianma_dcs_write_seq_static(ctx, 0x8B, 0xEF);
	tianma_dcs_write_seq_static(ctx, 0xB3, 0xE9);
	tianma_dcs_write_seq_static(ctx, 0xAC, 0xFA);
	tianma_dcs_write_seq_static(ctx, 0xAD, 0xF0);
	tianma_dcs_write_seq_static(ctx, 0x8C, 0xC2);
	tianma_dcs_write_seq_static(ctx, 0x8D, 0xC3);
	tianma_dcs_write_seq_static(ctx, 0x8E, 0xC4);
	tianma_dcs_write_seq_static(ctx, 0x8F, 0xC5);
	tianma_dcs_write_seq_static(ctx, 0x90, 0xDC);
	tianma_dcs_write_seq_static(ctx, 0x91, 0xDD);
	tianma_dcs_write_seq_static(ctx, 0x92, 0xE2);
	tianma_dcs_write_seq_static(ctx, 0x93, 0xE3);
	tianma_dcs_write_seq_static(ctx, 0x94, 0xE4);
	tianma_dcs_write_seq_static(ctx, 0x95, 0xE5);
	tianma_dcs_write_seq_static(ctx, 0xB4, 0xD9);
	tianma_dcs_write_seq_static(ctx, 0xAE, 0xDB);
	tianma_dcs_write_seq_static(ctx, 0x96, 0x98);
	tianma_dcs_write_seq_static(ctx, 0x97, 0x99);
	tianma_dcs_write_seq_static(ctx, 0x98, 0x9A);
	tianma_dcs_write_seq_static(ctx, 0x99, 0x9B);
	tianma_dcs_write_seq_static(ctx, 0x9A, 0xB7);
	tianma_dcs_write_seq_static(ctx, 0x9B, 0xB8);
	tianma_dcs_write_seq_static(ctx, 0x9E, 0xC1);
	tianma_dcs_write_seq_static(ctx, 0x9F, 0xC2);
	tianma_dcs_write_seq_static(ctx, 0xB5, 0xB0);
...
static int tianma_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "NT36672C_TM_apollo", "tm2048");
/*shifan@bsp.tp 2020.0310 add for making judge on normal mode */
...
static struct mipi_dsi_driver tianma_driver = {
	...
	.driver = {
			...
			.name = "oppo20609_tianma_ili7807s_cphy_vdo",
			.owner = THIS_MODULE,
